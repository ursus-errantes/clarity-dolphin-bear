...
def compute_VAR_db_for_signal(
    estimated_vocals: np.ndarray, estimated_accomp: np.ndarray
) -> float:
...
def run_compute_features(cfg: DictConfig) -> None:
    ...
    for record in tqdm(records):
        ...
        estimated_accomp = utilities.normalize_audio(
            estimated_accomp,
            44100,
            target_level_db=-20.0,
            lowcut=80.0,
        ...
        var_db = compute_VAR_db_for_signal(estimated_vocals, estimated_accomp)
